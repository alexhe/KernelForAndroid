...
void fi_register_nf_hook(struct fi_ctx *fictx)
{
	int ret;
...
void fi_unregister_nf_hook(struct fi_ctx *fictx)
{
	mutex_lock(&(fictx->nf_mutex));
...
/* find appid by uid */
static uint32_t fi_find_appid(uint32_t uid, struct fi_ctx *fictx)
{
	int i;
...
static void fi_appid_add(uint32_t appid, struct fi_ctx *fictx)
{
...
static void fi_appid_shrink(struct fi_ctx *fictx)
{
	uint32_t i;
...
static void fi_proc_applaunch(uint8_t *data, int32_t len, struct fi_ctx *fictx)
{
...
static void fi_proc_appstatus(uint8_t *data, int32_t len, struct fi_ctx *fictx)
{
...
void fi_para_init(struct fi_ctx *fictx)
{
	fi_flow_init();
