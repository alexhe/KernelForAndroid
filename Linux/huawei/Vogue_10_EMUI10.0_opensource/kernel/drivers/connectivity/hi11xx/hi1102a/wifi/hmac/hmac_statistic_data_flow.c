...
oal_void hmac_wifi_statistic_rx_amsdu(oal_uint32 ul_amsdu_cnt)
{
    g_st_wifi_rxtx_statis.st_pkgs_info.ul_rx_amsdu_pkt += ul_amsdu_cnt;
}
...
OAL_STATIC oal_uint32 hmac_wifi_calculate_stat(wifi_txrx_calculated_stat_stru *pst_calculated_stat)
{
    ...
    pst_calculated_stat->ul_tx_large_pps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_tx_large_pkt * 1000) / ul_dur_ms;
    pst_calculated_stat->ul_rx_large_pps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_rx_large_pkt * 1000) / ul_dur_ms;
    pst_calculated_stat->ul_tx_small_pps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_tx_small_pkt * 1000) / ul_dur_ms;
    pst_calculated_stat->ul_rx_small_pps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_rx_small_pkt * 1000) / ul_dur_ms;

    pst_calculated_stat->ul_rx_throughput_mbps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_rx_bytes >> 7) / ul_dur_ms;
    pst_calculated_stat->ul_tx_throughput_mbps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_tx_bytes >> 7) / ul_dur_ms;

    pst_calculated_stat->ul_rx_amsdu_pps = (g_st_wifi_rxtx_statis.st_pkgs_info.ul_rx_amsdu_pkt * 1000) / ul_dur_ms;
...
OAL_STATIC oal_void hmac_wifi_update_func_state(wifi_txrx_calculated_stat_stru *pst_calculated_stat)
{
    ...
    hmac_rx_dscr_th_opt(ul_tx_large_pps, ul_rx_large_pps, ul_tx_small_pps, 
                        ul_rx_small_pps, pst_calculated_stat->ul_rx_amsdu_pps);
