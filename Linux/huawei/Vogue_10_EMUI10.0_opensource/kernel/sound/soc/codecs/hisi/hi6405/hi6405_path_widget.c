...
static const struct reg_seq_config headphone_pop_on_regs[] = {
	...
	{ { CODEC_ANA_RWREG_056, 0x1 << CODEC_ANA_RST_CLK_POP_OFFSET |
		0x3 << CODEC_ANA_IBCT_HP_OFFSET | 0x3 << CODEC_ANA_IBCT_FB_OFFSET,
		0x1 << CODEC_ANA_RST_CLK_POP_OFFSET | 0x2 << CODEC_ANA_IBCT_HP_OFFSET |
		0x2 << CODEC_ANA_IBCT_FB_OFFSET, true }, 0, 0 }, /* tx_hp default */
	{ { CODEC_ANA_RWREG_056, 0x1 << CODEC_ANA_RST_CLK_POP_OFFSET, 0, true }, 0, 0 }, /* tx_hp pop work */
