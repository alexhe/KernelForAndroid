...
#endif
#define BBP_MIPI_MIPI0_RD_DATA_LOW_SOFT_OFFSET (0xD8)
#define BBP_MIPI_MIPI0_RD_DATA_HIGH_SOFT_OFFSET (0xDC)
#define BBP_MIPI_RD_END_FLAG_MIPI0_SOFT_OFFSET (0xE0)
#define BBP_MIPI_MIPI0_GRANT_DSP_OFFSET (0xE4)
#define BBP_MIPI_DSP_MIPI0_WDATA_LOW_OFFSET (0xE8)
#define BBP_MIPI_DSP_MIPI0_WDATA_HIGH_OFFSET (0xEC)
#define BBP_MIPI_DSP_MIPI0_EN_IMI_OFFSET (0xF0)
#define BBP_MIPI_DSP_MIPI0_CFG_IND_IMI_OFFSET (0xF4)
#define BBP_MIPI_DSP_MIPI0_RD_CLR_OFFSET (0xF8)
typedef union
{
    struct
    {
