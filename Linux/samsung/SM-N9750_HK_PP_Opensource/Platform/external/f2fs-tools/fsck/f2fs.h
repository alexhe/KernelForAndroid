...
struct f2fs_sb_info {
	...
	u64 user_block_count;               /* # of user blocks */
	u64 total_valid_block_count;        /* # of valid blocks */
	u64 alloc_valid_block_count;        /* # of allocated blocks */
	u64 last_valid_block_count;         /* for recovery */
