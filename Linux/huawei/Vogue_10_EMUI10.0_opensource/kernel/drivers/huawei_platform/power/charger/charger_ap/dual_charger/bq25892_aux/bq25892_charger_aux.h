...
#ifndef _BQ25892_CHARGER_AUX_H_
#define _BQ25892_CHARGER_AUX_H_
...
#define BQ25892_AUX_REG_00_IINLIM_MASK             (BIT(5) | BIT(4) | \
...
#define BQ25892_AUX_REG_01_VINDPM_OS_MASK          (BIT(4) | BIT(3) | \
	BIT(2) | BIT(1) | BIT(0))
...
#define BQ25892_AUX_REG_04_ICHG_MASK               (BIT(6) | BIT(5) | \
...
#define BQ25892_AUX_REG_05_IPRECHG_MASK            (BIT(7) | BIT(6) | \
	BIT(5) | BIT(4))
#define BQ25892_AUX_REG_05_IPRECHG_SHIFT           4
#define BQ25892_AUX_REG_05_ITERM_MASK              (BIT(3) | BIT(2) | \
	BIT(1) | BIT(0))
...
#define BQ25892_AUX_REG_06_VREG_MASK               (BIT(7) | BIT(6) | \
...
#define BQ25892_AUX_REG_0A_BOOSTV_MASK             (BIT(7) | BIT(6) | \
	BIT(5) | BIT(4))
...
#define BQ25892_AUX_REG_0E_BATV_MASK               (BIT(6) | BIT(5) | \
	BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define BQ25892_AUX_REG_0F_SYSV_MASK               (BIT(6) | BIT(5) | \
	BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define BQ25892_AUX_REG_11_VBUSV_MASK              (BIT(6) | BIT(5) | \
	BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define BQ25892_AUX_REG_12_ICHGR_MASK              (BIT(6) | BIT(5) | \
	BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define BQ25892_AUX_REG_13_IDPM_LIM_MASK           (BIT(5) | BIT(4) | \
	BIT(3) | BIT(2) | BIT(1) | BIT(0))
