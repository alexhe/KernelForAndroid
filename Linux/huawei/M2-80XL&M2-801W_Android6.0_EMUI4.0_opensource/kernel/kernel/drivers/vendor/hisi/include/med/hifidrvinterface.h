...
enum AUDIO_MSG_ENUM
{
    ...
    ID_AP_AUDIO_CMD_SET_ALGO_CFG_CMD    = 0xDD99,           /* _H2ASN_MsgChoice AUDIO_CMD_COMMON_SET_STRU */
...
/*****************************************************************************
 实体名称  : AUDIO_CMD_COMMON_ALGO_CFG_STRU
 功能描述  : 指定设备下的算法配置信息
*****************************************************************************/
typedef struct {
    unsigned short                      uhwMsgId;
    unsigned short                      uhwReserve;
    unsigned int                        uwDevice;
    unsigned int                        uwAlgoCfg;
} AUDIO_CMD_COMMON_ALGO_CFG_STRU;
