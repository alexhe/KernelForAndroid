...
Description:	ÖÐ¶Ï¹ì¼£¼ÇÂ¼
Input:		    dir:0ÖÐ¶Ï½øÈë£¬1ÖÐ¶ÏÍË³ö£¬new_vec:µ±Ç°ÖÐ¶Ï
Output:		    NA
Return:		    NA
********************************************************************************/
...
{
	/* ¼ÇÂ¼Ê±´Á¡¢cpu_id¡¢ÖÐ¶ÏºÅ¡¢ÖÐ¶Ï½ø³ö·½Ïò£» */
	irq_info info;
	u8 cpu;
...
Description:	¼ÇÂ¼ÄÚºËÈÎÎñ¹ì¼££»
Input:		    pre_task:µ±Ç°ÈÎÎñtask½á¹¹ÌåÖ¸Õë£¬next_task:ÏÂÒ»¸öÈÎÎñtask½á¹¹ÌåÖ¸Õë£»
Output:		    NA
Return:		    NA
...
{
	/* ¼ÇÂ¼Ê±´Á¡¢cpu_id¡¢next_taskµÄpid¡¢ÈÎÎñÃû£¬µ½¶ÔÓ¦cpuµÄÑ­»·buffer£» */
...
Description:	¼ÇÂ¼cpu½øÈëidleÏÂµç£¬ÍË³öidleÉÏµçµÄ¹ì¼£
Input:		    dir:0½øÈëidle or 1ÍË³öidle£»
Output:		    NA
Return:		    NA
********************************************************************************/
void cpuidle_stat_hook(u32 dir)
{
	/* ¼ÇÂ¼Ê±´Á¡¢cpu_id¡¢½øÈëidle»¹ÊÇÍË³öidle£¬µ½¶ÔÓ¦µÄÑ­»·buffer£» */
	cpuidle_info info;
	u8 cpu;
...
Description:	CPU²å°ÎºË¼ÇÂ¼£¬µ±Ç°ºÍSRÁ÷³Ì·¢ÉúµÄ³¡¾°Ò»ÖÂ
Input:		    cpu£ºcpuºÅ£¬on£º1¼ÓºË£¬0¼õºË
Output:		    NA
Return:		    NA
...
{
	/* ¼ÇÂ¼Ê±´Á£¬cpu_id¡¢cpuÊÇon»¹ÊÇoff£¬µ½¶ÔÓ¦µÄÑ­»·buffer£» */
	cpu_onoff_info info;
...
Description:	¼ÇÂ¼ÏµÍ³µ÷ÓÃ¹ì¼£
Input:		    syscall_num:ÏµÍ³µ÷ÓÃºÅ, dir:µ÷ÓÃ½ø³ö·½Ïò£¬0:½øÈë£¬1:ÍË³ö
Output:		    NA
Return:		    NA
...
{
	/* ¼ÇÂ¼Ê±´Á¡¢ÏµÍ³µ÷ÓÃºÅ£¬µ½¶ÔÓ¦µÄÑ­»·buffer£» */
	syscall_info info;
...
Description:	¼ÇÂ¼hung taskµÄtaskÐÅÏ¢£»
Input:		    tsk:ÈÎÎñ½á¹¹ÌåÖ¸Õë£¬timeout£º³¬Ê±Ê±¼ä£»
Output:		    NA
Return:		    NA
********************************************************************************/
void hung_task_hook(void *tsk, u32 timeout)
{
	/* ¼ÇÂ¼Ê±´Á¡¢ÈÎÎñpid¡¢³¬Ê±Ê±¼ä£¬µ½¶ÔÓ¦µÄÑ­»·buffer£» */
...
Description:     ¼ÇÂ¼tasklet Ö´ÐÐ¹ì¼£
Input:		    address:Îªtasklet ÒªÖ´ÐÐfunctionµÄ address, dir:µ÷ÓÃ½ø³ö·½Ïò£¬0:½øÈë£¬1:ÍË³ö
Output:		    NA
Return:		    NA
Other:          added to arch/arm64/kernel/entry.S
********************************************************************************/
...
{
	/* ¼ÇÂ¼Ê±´Á¡¢function address ¡¢CPU ºÅ,µ½¶ÔÓ¦µÄÑ­»·buffer */
	tasklet_info info;
	...
	info.cpu = (u8) smp_processor_id();
	info.dir = (u8) dir;
	//helin: tasklet trace enter/exit 跟踪日志
	hisiap_ringbuffer_write((struct hisiap_ringbuffer_s *)
...
Description:     ¼ÇÂ¼workerÖ´ÐÐ¹ì¼£
Input:		    address:Îªworker ÒªÖ´ÐÐfunctionµÄ address, dir:µ÷ÓÃ½ø³ö·½Ïò£¬0:½øÈë£¬1:ÍË³ö
Output:		    NA
Return:		    NA
Other:          added to arch/arm64/kernel/entry.S
********************************************************************************/
