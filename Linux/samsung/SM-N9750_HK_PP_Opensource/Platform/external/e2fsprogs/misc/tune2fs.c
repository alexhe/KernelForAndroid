...
#define DEFAULT_SEC_R_BLOCKS 1280
		fs->super->s_sec_r_blocks_count = DEFAULT_SEC_R_BLOCKS;
		ext2fs_mark_super_dirty(fs);
		printf(_("Setting reserved blocks count to %llu(SEC: %d)\n"),
		       reserved_blocks, DEFAULT_SEC_R_BLOCKS);
	}
	if (s_flag == 1) {
