...
extern VOS_VOID SLEEP_ActivateHw(SLEEP_MODE_ENUM_UINT32 enMode);
...
VOS_UINT32 OM_ReadNv(APP_OM_MSG_EX_STRU *pstAppToOmMsg, VOS_UINT16 usReturnPrimId)
{
    ...
    {
        usNvId = pstAppOmReadNv->ausNvItemId[ulIndex];
        (VOS_VOID)NV_GetLength(usNvId, &ulNvLen);
                                           ...
                                           VOS_UINT16 usReturnPrimId)
{
    ...
    if (VOS_NULL_WORD != pstLmtMsg->usSysMode)
    {
        ...
        {
            stRfSwitchFlag.usEnable    = VOS_FALSE;
        }
...
{
    {OM_ReadNv,                    APP_OM_READ_NV_REQ,                OM_APP_READ_NV_IND},
    {OM_WriteNv,                   APP_OM_WRITE_NV_REQ,               OM_APP_WRITE_NV_CNF},
    {OM_BackupNv,                  APP_OM_NV_BACKUP_REQ,              OM_APP_NV_BACKUP_CNF},
    {OM_GetNvIdList,               APP_OM_NV_ID_LIST_REQ,             OM_APP_NV_ID_LIST_CNF},
    {OM_GetAperiodicStatus,        APP_OM_APER_STASTUS_REQ,           OM_APP_APER_STASTUS_IND},
    {OM_QueryMemory,               APP_OM_QUERY_MM_REQ,               OM_APP_QUERY_MM_IND},
    {OM_SetBootFlagConfig,         APP_OM_SET_BOOT_REQ,               OM_APP_SET_BOOT_CNF},
    {OM_QueryVersionInfo,          APP_OM_QUERY_VER_REQ,              OM_APP_QUERY_VER_IND},
    {OM_SysparaGetUsimFileReq,     APP_OM_GET_USIM_REQ,               OM_APP_GET_USIM_CNF},
    {OM_SysparaSetUsimFileReq,     APP_OM_SET_USIM_REQ,               OM_APP_SET_USIM_CNF},
    {OM_LmtMsgProc,                APP_OM_HANDLE_LMT_REQ,             OM_APP_HANDLE_LMT_CNF},
    {OM_ActivePhyProc,             APP_OM_ACTIVE_PHY_REQ,             OM_APP_ACTIVE_PHY_CNF},
    {OM_QueryDspType,              APP_OM_QUERY_DSP_REQ,              OM_APP_QUERY_DSP_CNF},
    {OM_QueryPA,                   APP_OM_PA_ATTRIBUTE_REQ,           OM_APP_PA_ATTRIBUTE_IND},
    {OM_RebootUE,                  APP_OM_REBOOT_REQ,                 OM_APP_REBOOT_CNF},
    {OM_GetVersion,                APP_OM_VERSION_REQ,                OM_APP_VERSION_IND},
    {OM_SetFTMReq,                 APP_OM_SET_FTM_REQ,                OM_APP_SET_FTM_CNF},
    {OM_LoadDefault,               APP_OM_LOAD_DEFAULT_REQ,           OM_APP_LOAD_DEFAULT_CNF},
    {OM_QueryUELabel,              APP_OM_QUERY_LABEL_REQ,            OM_APP_QUERY_LABEL_IND},
    {OM_QueryMemInfo,              APP_OM_QUERY_MEM_INFO_REQ,         OM_APP_QUERY_MEM_INFO_IND},
    {OM_EstablishReq,              APP_OM_ESTABLISH_REQ,              OM_APP_ESTABLISH_CNF},
    {OM_ReleaseReq,                APP_OM_RELEASE_REQ,                OM_APP_RELEASE_CNF},
    {OM_Authorize,                 APP_OM_AUTHORIZE_REQ,              OM_APP_AUTHORIZE_CNF},
    {OM_GetFilterListReq,          APP_OM_FILTER_LIST_REQ,            OM_APP_FILTER_LIST_CNF},
#if (FEATURE_ON == FEATURE_MANUFACTURE_LOG)
    {OM_StartUpLogSaveReq,         APP_OM_START_UP_LOG_REQ,           OM_APP_START_UP_LOG_CNF},
    {OM_StopLogSaveReq,            APP_OM_STOP_LOG_REQ,               OM_APP_STOP_LOG_CNF},
#endif
...
OM_VERSION_QRY_DEBUG_INFO_STRU  g_stVerQryDbgInfo = {0,0,0,0};
...
VOS_VOID OM_MmaMsgProc(MsgBlock *pstMsg)
{
    ...
    if (TAF_OAM_PHONE_EVENT_IND == ulPrimId)
    {
        ...
        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)(pstEvent->stPhoneEvent.OpId), ucFuncType, pstEvent->stPhoneEvent.PhoneError, OM_APP_SET_FTM_CNF);
    }
    else if (TAF_OAM_PHONE_SET_CNF == ulPrimId)
    {
        pstLoadDefault = (MN_APP_PHONE_SET_CNF_STRU *)pstMsg;

        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)(pstLoadDefault->opID), ucFuncType, pstLoadDefault->ucResult, OM_APP_LOAD_DEFAULT_CNF);
    }
    else
    {
        PS_LOG1(WUEPS_PID_OM, 0, PS_PRINT_ERROR,
...
VOS_UINT32 OM_BackupNv(APP_OM_MSG_EX_STRU *pstAppToOmMsg, VOS_UINT16 usReturnPrimId)
{
    ...
    OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)OM_LOGIC_CHANNEL_CBT, pstAppToOmMsg->ucFuncType, ulResult, usReturnPrimId);
    return VOS_OK;
}
...
VOS_UINT32 OM_ReadNv(APP_OM_MSG_EX_STRU *pstAppToOmMsg, VOS_UINT16 usReturnPrimId)
{
    ...
    for (ulIndex = 0; ulIndex < ulCount; ulIndex++)
    {
        ...
        {
            NV_GET_RETURN(ulResult, usNvId);
            OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, ulResult, usReturnPrimId);
            PS_LOG1(WUEPS_PID_OM, 0, PS_PRINT_ERROR,
                        "OM_ReadNv:NV_GetLength, NV id: ",(VOS_INT32)usNvId);
    ...
    if (VOS_NULL_PTR == pstOmToAppMsg)
    {
        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)NV_ALLOC_BUFFER_FAIL, usReturnPrimId);
        PS_LOG(WUEPS_PID_OM, 0, PS_PRINT_ERROR, "OM_ReadNv:VOS_MemAlloc.\n");
        return VOS_ERR;
...
VOS_UINT32 OM_WriteNv(APP_OM_MSG_EX_STRU *pstAppToOmMsg, VOS_UINT16 usReturnPrimId)
{
    ...
    for (ulIndex = 0; ulIndex < ulCount; ulIndex++)
    {
        ...
        if (VOS_YES != OM_IsAuthNv(usNvId))
        {
            OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)OM_NEED_AUTH, usReturnPrimId);
            PS_LOG1(WUEPS_PID_OM, 0, PS_PRINT_WARNING,
                    "OM_WriteNv:OM_IsAuthNv, NV id:", (VOS_INT32)usNvId);
    ...
    OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)NV_OK, usReturnPrimId);
                                          ...
                                          VOS_UINT16 usReturnPrimId)
{
    ...
    {
        /*0 indicates the count of the memory contents is zero, failed.*/
        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)0, usReturnPrimId);
        PS_LOG(WUEPS_PID_OM, 0, PS_PRINT_ERROR, "OM_QueryMemory:VOS_MemAlloc.\n");
        return VOS_ERR;
    }
    pstMemInd = (OM_QUERY_MEMORY_STRU*)(pstOmToAppMsg->aucPara);
                                                    ...
                                                    VOS_UINT16 usReturnPrimId)
{
    ...
    OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)VOS_OK, usReturnPrimId);
    return VOS_OK;
}
                                                     ...
                                                     VOS_UINT16 usReturnPrimId)
{
    ...
    g_stVerQryDbgInfo.ulVerQryRcvCnt++;
    ...
    if (VOS_NULL_PTR == pstOmToAppMsg)
    {
        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)OM_LOGIC_CHANNEL_CNF, pstAppToOmMsg->ucFuncType, (VOS_UINT32)VOS_ERR, usReturnPrimId);
        PS_LOG(WUEPS_PID_OM, 0, PS_PRINT_WARNING, "OM_QueryVersionInfo: VOS_MemAlloc.\n");
        g_stVerQryDbgInfo.ulAllocMemFail++;
        return VOS_ERR;
    }

    VOS_MemSet(pstOmToAppMsg, 0, ulTotalSize);
    ...
    /*Assign the length field.*/
    pstOmToAppMsg->usLength = (VOS_UINT16)(ulTotalSize - VOS_OM_HEADER_LEN);
    //OM_SendResultChannel(OM_LOGIC_CHANNEL_CNF, pstAppToOmMsg->ucFuncType, pstOmToAppMsg, usReturnPrimId);
    OM_SendContentChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)OM_LOGIC_CHANNEL_CNF, pstAppToOmMsg->ucFuncType, pstOmToAppMsg, usReturnPrimId);
    /* Debug */
    temp = (VOS_UINT16)(pstOmToAppMsg->usLength + VOS_OM_HEADER_LEN);
    pucData = (VOS_UINT8*)pstOmToAppMsg;
    if (1 == g_ulOmVersionDbg)
                                           ...
                                           VOS_UINT16 usReturnPrimId)
{
    ...
    if(MODEM_ID_BUTT <= enModemID)
    {
        OM_SendResultChannel(pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, VOS_ERR, usReturnPrimId);
        PS_LOG(WUEPS_PID_OM, 0, PS_PRINT_ERROR, "OM_SetFTMReq:Modem ID Error!");
        return VOS_ERR;
    }
    ...
    OM_SendResultChannel(pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, VOS_OK, usReturnPrimId);
                                        ...
                                        VOS_UINT16 usReturnPrimId)
{
    ...
    OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, ulDspType, usReturnPrimId);
                                           ...
                                           VOS_UINT16 usReturnPrimId)
{
    ...
    stFactoryVersion.ulResult = VOS_OK;
    stFactoryVersion.usLength = sizeof(OM_FACTORY_VER_STRU) - VOS_OM_HEADER_LEN;
    OM_SendContentChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (OM_APP_MSG_EX_STRU*)(&stFactoryVersion), usReturnPrimId);
    return VOS_OK;
}


VOS_UINT32 OM_SysCtrlCmd(OM_LOGIC_CHANNEL_ENUM_UINT32 enChannel, VOS_UINT16 usClientId, VOS_UINT32 ulMode, MODEM_ID_ENUM_UINT16 enModemID)
{
    MN_APP_PHONE_MODE_SET_REQ_STRU *pstMsg;
    ...
    /* 发送消息给NAS进行系统控制 */
    pstMsg->usClientId         = usClientId;
    pstMsg->opID               = (VOS_UINT8)enChannel;
    pstMsg->stPhOpMode.CmdType = TAF_PH_CMD_SET;
    pstMsg->stPhOpMode.PhMode  = (VOS_UINT8)ulMode;
    pstMsg->stPhOpMode.PhReset = TAF_PH_OP_MODE_UNRESET;
...
{
    /* 会在校准和IND通道上报 */
    if (VOS_OK != OM_SysCtrlCmd((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, (VOS_UINT16)OAM_CLIENT_ID_OM,
                                *((VOS_UINT32*)pstAppToOmMsg->aucPara),
                                OM_GET_FUNCID_MODEMINFO(pstAppToOmMsg->ucFuncType)))
    {
        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)VOS_ERR, usReturnPrimId);
...
VOS_UINT32 OM_LoadDefCmd(OM_LOGIC_CHANNEL_ENUM_UINT32 enChannel, VOS_UINT16 usClientId)
{
    MN_APP_PHONE_LOADDEFAULT_REQ_STRU *pstMsg;
...
{
    /* 会在校准和IND通道上报 */
    if (VOS_OK != OM_LoadDefCmd((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, (VOS_UINT16)OAM_CLIENT_ID_OM))
    {
        OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)VOS_ERR, usReturnPrimId);
                                           ...
                                           VOS_UINT16 usReturnPrimId)
{
    ...
    OM_SendContentChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (OM_APP_MSG_EX_STRU*)&stOmImei,
                        usReturnPrimId);
    return VOS_OK;
}
VOS_UINT32 OM_QueryMemInfo(APP_OM_MSG_EX_STRU *pstAppToOmMsg,
...
VOS_UINT32 OM_EstablishCbtProc(APP_OM_MSG_EX_STRU *pstAppToOmMsg,
                                           VOS_UINT16 usReturnPrimId)
{
...
VOS_UINT32 OM_EstablishCnfProc(APP_OM_MSG_EX_STRU *pstAppToOmMsg,
                                           VOS_UINT16 usReturnPrimId)
{
    /* 链路断开 */
    g_ulOMSwitchOnOff = OM_STATE_IDLE;
...
VOS_UINT32 OM_EstablishReq(APP_OM_MSG_EX_STRU *pstAppToOmMsg,
                                           VOS_UINT16 usReturnPrimId)
{
    if (OM_LOGIC_CHANNEL_CBT == (OM_LOGIC_CHANNEL_ENUM_UINT32)(pstAppToOmMsg->ucCpuId))
    {
        OM_EstablishCbtProc(pstAppToOmMsg, usReturnPrimId);

        return VOS_OK;
    }

    OM_EstablishCnfProc(pstAppToOmMsg, usReturnPrimId);

    return VOS_OK;
}


VOS_UINT32 OM_ReleaseCbtProc(APP_OM_MSG_EX_STRU *pstAppToOmMsg,
                                           VOS_UINT16 usReturnPrimId)
{
...
VOS_UINT32 OM_ReleaseCnfProc(APP_OM_MSG_EX_STRU *pstAppToOmMsg,
                                           VOS_UINT16 usReturnPrimId)
{
    g_ulOMSwitchOnOff           = OM_STATE_IDLE;
                                           ...
                                           VOS_UINT16 usReturnPrimId)
{
    if (OM_LOGIC_CHANNEL_CBT == (OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId)
    {
        OM_ReleaseCbtProc(pstAppToOmMsg, usReturnPrimId);

        return VOS_OK;
    }

    OM_ReleaseCnfProc(pstAppToOmMsg, usReturnPrimId);
                                            ...
                                            VOS_UINT16 usReturnPrimId)
{
    ...
    OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)lResult, usReturnPrimId);
                                            ...
                                            VOS_UINT16 usReturnPrimId)
{
    ...
    OM_SendResultChannel((OM_LOGIC_CHANNEL_ENUM_UINT32)pstAppToOmMsg->ucCpuId, pstAppToOmMsg->ucFuncType, (VOS_UINT32)ulModemNum, usReturnPrimId);
