...
/*****************************************************************************
 Prototype    : check_ntfs_volume
 Description  : check if buffer contains a valid ntfs boot sector
 Input        : dev   : device path
 Input        : flags :
 Output       : None
 Return Value : 
 Calls        : 
 Called By    : 
  ...
  1.Date         : 2011/7/13
    Author       : x00186870
    Modification : Created function  PN:NTFS-3G
...
/*****************************************************************************
 Prototype    : check_ntfs
 Description  : check device is formated by ntfs
 Input        : None
 Output       : None
 Return Value : int
 Called By    : 
