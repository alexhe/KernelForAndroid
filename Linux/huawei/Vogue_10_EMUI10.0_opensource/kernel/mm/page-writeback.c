 ...
 */
int dirty_background_ratio = 10; //helin: 脏页 达到10% 以上，触发flush 回写
 ...
 */
unsigned int dirty_writeback_interval = 5 * 100; /* centiseconds */ //helin: 5s 间隔 刷新 回写
 ...
 */
unsigned int dirty_expire_interval = 30 * 100; /* centiseconds */ //helin: 脏页最大存活时间30s
