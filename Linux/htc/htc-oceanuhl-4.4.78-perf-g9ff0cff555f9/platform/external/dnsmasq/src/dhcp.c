		     ...
		     struct dhcp_netid *netids, time_t now)   
{
  ...
  // ++ PCND0007_DNSMASQ_REMOVE_PING_WAIT_FOR_MIRRORLINK
  // ** [start] Network - 20150109 Ignore icmp_ping for CTS and shortening of DHCP process on ML
  struct dhcp_netid mirrorlink_id;
  // ** [end] Network - 20150109 Ignore icmp_ping for CTS and shortening of DHCP process on ML
  // -- PCND0007_DNSMASQ_REMOVE_PING_WAIT_FOR_MIRRORLINK
