...
#ifdef HAVE_SETXATTR
/* BEGIN: Deleted by l00198597, 2012/1/18 FOR NTFS-3G*/
/*#include <sys/xattr.h>*/
/* END: Deleted by l00198597, 2012/1/18 FOR NTFS-3G */
#endif
			    ...
			    struct statfs *sfs)
{
	...
	if (size < 0)
		size = 0;
/* BEGIN: Modified by l00198597, 2012/1/18 FOR NTFS-3G*/
...
/* END: Modified by l00198597, 2012/1/18 FOR NTFS-3G */
