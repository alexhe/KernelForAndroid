...
void ts_algo_calibrate(struct ts_cmd_node *in_cmd,
			struct ts_cmd_node *out_cmd);
...
int ts_calibrate(struct ts_cmd_node *in_cmd,
			struct ts_cmd_sync *sync);
...
int ts_palm_switch(struct ts_cmd_node *in_cmd,
			struct ts_cmd_sync *sync);

int ts_hand_detect(struct ts_cmd_node *in_cmd);

int ts_force_reset(struct ts_cmd_node *in_cmd,
			struct ts_cmd_node *out_cmd);

int ts_int_err_process(struct ts_cmd_node *in_cmd,
			struct ts_cmd_node *out_cmd);

int ts_err_process(struct ts_cmd_node *in_cmd,
			struct ts_cmd_node *out_cmd);

int ts_check_status(struct ts_cmd_node *in_cmd,
			struct ts_cmd_node *out_cmd);
...
int ts_test_cmd(struct ts_cmd_node *in_cmd,
			struct ts_cmd_node *out_cmd);
...
int ts_send_roi_cmd(enum ts_action_status read_write_type,
			int timeout);
