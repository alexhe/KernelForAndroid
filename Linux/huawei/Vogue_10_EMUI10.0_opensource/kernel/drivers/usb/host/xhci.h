...
#define XHCI_CTRL_NYET_ABNORMAL		(1 << 31)
#ifdef CONFIG_USB_DWC3_NYET_ABNORMAL
#define XHCI_DISABLE_LPM		(1 << 32)
#define XHCI_NOT_SUP_SG			(1ULL << 33)
#define XHCI_HCD_LOCAL_MEM		(1ULL << 34)
#endif /* CONFIG_USB_DWC3_NYET_ABNORMAL */
#define XHCI_WARM_RESET_AFTER_INIT	(1ULL << 35)
#define XHCI_DELAY_CTRL_DATA_STAGE	(1ULL << 36)
