...
#define BLK_LLD_LATENCY_STATISTIC_ENABLE                                       \
	(1ULL << __BLK_LLD_LATENCY_STATISTIC_ENABLE)
...
extern void hisi_blk_req_bio_endio(struct request *rq, struct bio *bio,
...
extern void hisi_blk_latency_writeback_bio(
	struct request *req, struct bio *bio);
