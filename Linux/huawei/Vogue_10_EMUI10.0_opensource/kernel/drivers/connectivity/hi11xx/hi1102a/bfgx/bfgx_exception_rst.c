...
int32 plat_exception_handler(uint32 subsys_type, uint32 thread_type, uint32 exception_type)
{
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_PLAT, CHR_LAYER_DRV,
                         CHR_WIFI_DRV_EVENT_PLAT, CHR_WIFI_DRV_ERROR_EXCEPTION_HANDLE);
...
int32 wifi_exception_handler(void)
{
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DRV,
                         CHR_WIFI_DRV_EVENT_EXCEPTION, CHR_WIFI_DRV_ERROR_EXCEPTION_WIFI_HANDLE);
...
{
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DRV,
                         CHR_WIFI_DRV_EVENT_PLAT, CHR_WIFI_DRV_ERROR_BFGX_SUB_SYSTEM_RESET);
...
int32 bfgx_system_reset(void)
{
    ...
    CHR_EXCEPTION_REPORT(CHR_PLATFORM_EXCEPTION_EVENTID, CHR_SYSTEM_WIFI, CHR_LAYER_DRV,
                         CHR_WIFI_DRV_EVENT_PLAT, CHR_WIFI_DRV_ERROR_BFGX_SYSTEM_RESET);
