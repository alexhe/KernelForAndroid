...
static struct sensor_power_setting imx600hybrid_power_setting_laya_pie [] = {
	/* AFVDD GPIO 004 ENABLE */
	/* Power up vcm first, then power up AVDD1 */
	/* XBUCK_AFVDD 2V55---| bucker |---> AVDD1 1V8 */
	{
...
static sensor_t s_imx600hybrid_laya_pie = {
	.intf = { .vtbl = &s_imx600hybrid_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(imx600hybrid_power_setting_laya_pie),
		.power_setting = imx600hybrid_power_setting_laya_pie,
	},
};

/* support both imx600hybrid & imx318legacydual */
static const struct of_device_id s_imx600hybrid_dt_match[] = {
	{
	...
	},
	{
		...
		.data = &s_imx600hybrid_laya_pie.intf,
	},
