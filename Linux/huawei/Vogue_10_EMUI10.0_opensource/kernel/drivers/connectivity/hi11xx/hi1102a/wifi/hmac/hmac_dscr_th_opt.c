...
OAL_STATIC oal_void hmac_rx_dscr_base_th_update(hmac_dscr_th_opt_stru *pst_dscr_th_opt)
{
    ...
    if (pst_dscr_th_opt->ul_rx_amsdu_pps > HMAC_DSCR_TH_UPDATE_AMSDU_TH)
    {
        /* Rx amsdu pps每增加150多分配1个大包描述符, 上限为HMAC_LARGE_DSCR_TH_LIMIT_HIGH */
        ul_base_th = OAL_MIN(g_ul_large_start_th + pst_dscr_th_opt->ul_rx_amsdu_pps / 150, HMAC_LARGE_DSCR_TH_LIMIT_HIGH);
    }
    else
    {
...
OAL_STATIC oal_void hmac_flow_statistics_update(hmac_device_stru *pst_hmac_device, oal_uint32 ul_tx_large_pps, oal_uint32 ul_rx_large_pps,
                                                oal_uint32 ul_tx_small_pps, oal_uint32 ul_rx_small_pps, oal_uint32 ul_rx_amsdu_pps)
{
    ...
    pst_hmac_device->st_dscr_th_opt.ul_rx_amsdu_pps = ul_rx_amsdu_pps;
}


oal_void hmac_rx_dscr_th_opt(oal_uint32 ul_tx_large_pps, oal_uint32 ul_rx_large_pps, oal_uint32 ul_tx_small_pps,
                            oal_uint32 ul_rx_small_pps, oal_uint32 ul_rx_amsdu_pps)
{
    ...
    hmac_flow_statistics_update(pst_hmac_device, ul_tx_large_pps, ul_rx_large_pps, ul_tx_small_pps, ul_rx_small_pps, ul_rx_amsdu_pps);
