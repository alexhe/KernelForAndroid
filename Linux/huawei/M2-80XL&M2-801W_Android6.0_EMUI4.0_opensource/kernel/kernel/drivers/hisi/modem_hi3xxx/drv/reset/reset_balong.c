...
#include <linux/hisi/hi3xxx_rproc.h>
#endif
...
#if defined(CONFIG_HISI_RPROC) || defined(CONFIG_HI3XXX_RPROC)
...
void master_in_idle_timestamp_dump(void)
{
	...
	readl((volatile const void *)SHM_MEM_CCORE_RESET_ADDR), readl((volatile const void *)STAMP_RESET_FIQ_COUNT), readl((volatile const void *)STAMP_RESET_IDLE_FAIL_COUNT), readl((volatile const void *)STAMP_RESET_MASTER_ENTER_IDLE));
	printk(KERN_ERR "[cipher_chn_dis]0x%-8x [cipher_inidle]0x%-8x [cipher_reset ]0x%-8x [edma_bus_stop]0x%-8x\n", 
	readl((volatile const void *)STAMP_RESET_CIPHER_DISABLE_CHANNLE), readl((volatile const void *)STAMP_RESET_CIPHER_ENTER_IDLE),readl((volatile const void *)STAMP_RESET_CIPHER_SOFT_RESET), readl((volatile const void *)STAMP_RESET_EDMA_STOP_BUS));
	printk(KERN_ERR "[edma_inidle   ]0x%-8x [upacc_inidle1]0x%-8x [upacc_inidle2]0x%-8x [upacc_inidle3]0x%-8x\n", 
	readl((volatile const void *)STAMP_RESET_EDMA_ENTER_IDLE), readl((volatile const void *)STAMP_RESET_UPACC_ENTER_IDLE_1), readl((volatile const void *)STAMP_RESET_UPACC_ENTER_IDLE_2), readl((volatile const void *)STAMP_RESET_UPACC_ENTER_IDLE_3));
	printk(KERN_ERR "[cicom0_rst    ]0x%-8x [cicom1_rst   ]0x%-8x [ipf_inidle   ]0x%-8x [ipf_rst      ]0x%-8x\n", 
	readl((volatile const void *)STAMP_RESET_CICOM0_SOFT_RESET), readl((volatile const void *)STAMP_RESET_CICOM1_SOFT_RESET), readl((volatile const void *)STAMP_RESET_IPF_SOFT_RESET), readl((volatile const void *)STAMP_RESET_IPF_ENTER_IDLE));
	printk(KERN_ERR "[bbp_dma_inidle]0x%-8x [wbbp_mst_stop]0x%-8x [wbbp_slv_stop]0x%-8x [wbbp_inidle  ]0x%-8x\n", 
	readl((volatile const void *)STAMP_RESET_BBP_DMA_ENTER_IDLE), readl((volatile const void *)STAMP_RESET_WBBP_MSTER_STOP), readl((volatile const void *)STAMP_RESET_WBBP_SLAVE_STOP), readl((volatile const void *)STAMP_RESET_WBBP_ENTER_IDLE));
	printk(KERN_ERR "[flow_end      ]0x%-8x\n", readl((volatile const void *)STAMP_RESET_MASTER_IDLE_QUIT));
