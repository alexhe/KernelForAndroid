...
static const struct _sensor_reg_t ov13850_chm_framesize_fullsize_nonzsl_long_expo[] = {
...
//XCLK = 20.57M, sysclk = 12.08M, MIPIBitRate = 114.28Mbps/lane
static const struct _sensor_reg_t ov13850_chm_framesize_fullsize_nonzsl_8S_expo[] ={
{0x0100, 0x00},//software standby
{0x0300, 0x00},
{0x0302, 0x32},
{0x0303, 0x08},
...
static framesize_s ov13850_chm_framesizes[] = {
    //2080x1560, 30fps
    {0, 0, 2080, 1560, 4736, 1786, 30, 30, 0x214, 0x1bb, 0x100, VIEW_FULL, RESOLUTION_4_3, false, false, ECGC_TYPE_MAX, {ov13850_chm_framesize_quater, ARRAY_SIZE(ov13850_chm_framesize_quater)}, CLK_500M,33417, 253754880},
    //4160x3120, 10fps
    ...
    //4160x3120, 13fps
    {0, 0, 4160, 3120, 5704, 3328, 13, 13, 0x1B0, 0x168, 0xD0, VIEW_FULL, RESOLUTION_4_3, false, false, ECGC_TYPE_NORMAL_BSHUTTER_SHORT, {ov13850_chm_framesize_fullsize_nonzsl, ARRAY_SIZE(ov13850_chm_framesize_fullsize_nonzsl)}, CLK_500M,76718, 246777856},
    //4160x3120, 3.02fps long expo
    {0, 0, 4160, 3120, 4800, 3328, 3, 3, 0x65, 0x54, 0xD0, VIEW_FULL, RESOLUTION_4_3, false, false, ECGC_TYPE_BSHUTTER_LONG,{ov13850_chm_framesize_fullsize_nonzsl_long_expo, ARRAY_SIZE(ov13850_chm_framesize_fullsize_nonzsl_long_expo)}, CLK_150M,3296680, 48242688},
    //4160x3120, 1.129fps long expo
    {0, 0, 4160, 3120, 12800, 3344, 1, 1, 0x26, 0x1f, 0x12, VIEW_FULL, RESOLUTION_4_3, false, false, ECGC_TYPE_MAX,{ov13850_chm_framesize_fullsize_nonzsl_8S_expo, ARRAY_SIZE(ov13850_chm_framesize_fullsize_nonzsl_8S_expo)}, CLK_150M, 8001009, 48324813},
};
