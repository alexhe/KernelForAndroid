...
#define INTF2ICE40(i) container_of(i, struct ice40_t, intf)

static struct ice40_t s_ice40;
...
static struct hwfpga_vtbl_t s_vtbl_ice40 = {
...
static const struct of_device_id s_ice40_dt_match[] = {
	{
...
static struct platform_driver s_ice40_driver = {
	.driver = {
		.name = "huawei,ice40",
		.owner = THIS_MODULE,
