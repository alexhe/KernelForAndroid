...
HI_VOID vedu_hal_cfg_reg_addr_set(const struct encode_info *channel_cfg, HI_U32 *reg_base)
{
	...
	all_reg->VEDU_VCPI_TUNLCELL_ADDR = channel_cfg->all_reg.VEDU_VCPI_TUNLCELL_ADDR;//pEncPara_channel->VEDU_SRC_YADDR;//pEncPara->vcpi_curld_tunlcell_addr;
	all_reg->VEDU_VCPI_SRC_YADDR = channel_cfg->all_reg.VEDU_VCPI_SRC_YADDR;//pEncPara_channel->VEDU_SRC_YADDR;//pEncPara->vcpi_curld_y_addr;
	all_reg->VEDU_VCPI_SRC_CADDR = channel_cfg->all_reg.VEDU_VCPI_SRC_CADDR;//pEncPara_channel->VEDU_SRC_CADDR;//pEncPara->vcpi_curld_c_addr;
	all_reg->VEDU_VCPI_SRC_VADDR = channel_cfg->all_reg.VEDU_VCPI_SRC_VADDR;//pEncPara_channel->VEDU_SRC_VADDR;//pEncPara->vcpi_curld_v_addr;
	...
	if (channel_cfg->all_reg.VEDU_VCPI_STRFMT.bits.vcpi_str_fmt == 10) {
		all_reg->VEDU_VCPI_YH_ADDR = channel_cfg->all_reg.VEDU_VCPI_YH_ADDR;//pEncPara->vcpi_curld_yh_addr;
		all_reg->VEDU_VCPI_CH_ADDR = channel_cfg->all_reg.VEDU_VCPI_CH_ADDR;//pEncPara->vcpi_curld_ch_addr;
		{
		...
		HI_DBG_VENC("reg VEDU_VCPI_CH_ADDR=%pK\n", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_YH_ADDR));
		HI_DBG_VENC("reg VEDU_VCPI_CH_ADDR=%pK\n", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_CH_ADDR));
		HI_DBG_VENC("reg vcpi_curld_srcch_stride=%x\n", channel_cfg->all_reg.VEDU_CURLD_SRCH_STRIDE.bits.vcpi_curld_srcch_stride);
		HI_DBG_VENC("reg vcpi_curld_srcyh_stride=%x\n", channel_cfg->all_reg.VEDU_CURLD_SRCH_STRIDE.bits.vcpi_curld_srcyh_stride);
	}
	...
	//
	//REC-------------------REC-----------------REC--------------------------------------------
	all_reg->VEDU_VCPI_REC_YADDR = channel_cfg->all_reg.VEDU_VCPI_REC_YADDR;//pEncPara->vcpi_recst_yaddr;
	all_reg->VEDU_VCPI_REC_CADDR = channel_cfg->all_reg.VEDU_VCPI_REC_CADDR;//pEncPara->vcpi_recst_caddr;
	{
		all_reg->VEDU_VCPI_REC_STRIDE.u32 = channel_cfg->all_reg.VEDU_VCPI_REC_STRIDE.u32;
	}

	all_reg->VEDU_VCPI_REC_YH_ADDR = channel_cfg->all_reg.VEDU_VCPI_REC_YH_ADDR;//pEncPara->vcpi_recst_yh_addr;
	all_reg->VEDU_VCPI_REC_CH_ADDR = channel_cfg->all_reg.VEDU_VCPI_REC_CH_ADDR;//pEncPara->vcpi_recst_ch_addr;
	{
	...
	all_reg->VEDU_VCPI_REFY_L1_ADDR = channel_cfg->all_reg.VEDU_VCPI_REFY_L1_ADDR;//pEncPara_channel->VEDU_REFY_L1_ADDR;
	all_reg->VEDU_VCPI_REFC_L1_ADDR = channel_cfg->all_reg.VEDU_VCPI_REFC_L1_ADDR;//pEncPara_channel->VEDU_REFC_L1_ADDR;
	{
		all_reg->VEDU_VCPI_REF_L1_STRIDE.u32 = channel_cfg->all_reg.VEDU_VCPI_REF_L1_STRIDE.u32;
	}

	all_reg->VEDU_VCPI_REFYH_L1_ADDR = channel_cfg->all_reg.VEDU_VCPI_REFYH_L1_ADDR;//pEncPara_channel->VEDU_REFYH_L1_ADDR;
	all_reg->VEDU_VCPI_REFCH_L1_ADDR = channel_cfg->all_reg.VEDU_VCPI_REFCH_L1_ADDR;//pEncPara_channel->VEDU_REFCH_L1_ADDR;

	{
		all_reg->VEDU_VCPI_REFH_L1_STRIDE.u32 = channel_cfg->all_reg.VEDU_VCPI_REFH_L1_STRIDE.u32;
	}
	all_reg->VEDU_VCPI_PMELD_L1_ADDR = channel_cfg->all_reg.VEDU_VCPI_PMELD_L1_ADDR;//pEncPara_channel->VEDU_PMELD_L1_ADDR;

	//PME NBI

	all_reg->VEDU_VCPI_PMEST_ADDR = channel_cfg->all_reg.VEDU_VCPI_PMEST_ADDR;//pEncPara->vcpi_pmest_addr;
	...
	all_reg->VEDU_VCPI_NBI_MVST_ADDR = channel_cfg->all_reg.VEDU_VCPI_NBI_MVST_ADDR;//pEncPara->vcpi_mvst_address;
	all_reg->VEDU_VCPI_NBI_MVLD_ADDR = channel_cfg->all_reg.VEDU_VCPI_NBI_MVLD_ADDR;//pEncPara->vcpi_mvld_address;
	//PMEINFO
	all_reg->VEDU_VCPI_PMEINFO_ST_ADDR = channel_cfg->all_reg.VEDU_VCPI_PMEINFO_ST_ADDR;//pEncPara->vcpi_pmest_info_addr;
	all_reg->VEDU_VCPI_PMEINFO_LD0_ADDR = channel_cfg->all_reg.VEDU_VCPI_PMEINFO_LD0_ADDR;//pEncPara->vcpi_pmeinfo_ld_0_addr;
	all_reg->VEDU_VCPI_PMEINFO_LD1_ADDR = channel_cfg->all_reg.VEDU_VCPI_PMEINFO_LD1_ADDR;//pEncPara_channel->VEDU_PMEINFO_LD1_ADDR;//pEncPara->vcpi_pmeinfo_ld_1_addr;
	//QPGLD
	all_reg->VEDU_VCPI_QPGLD_INF_ADDR = channel_cfg->all_reg.VEDU_VCPI_QPGLD_INF_ADDR;//pEncPara->vcpi_qpgld_inf_addr;
}
...
HI_VOID vedu_hal_cfg_reg_smmu_set(HI_U32 *reg_base)
{
	...
	all_reg->SMMU_SCR.bits.rqos = 2;
	all_reg->SMMU_SCR.bits.wqos = 2;

	all_reg->SMMU_CB_SCTRL.bits.cb_bypass = 0;
	all_reg->SMMU_CB_TTBCR.bits.cb_ttbcr_des = 1;//channel_cfg->all_reg.SMMU_CB_TTBCR.bits.cb_ttbcr_des;
	all_reg->SMMU_CB_TTBR0 = smmu_page_base_addr;/*lint !e712 */
	all_reg->SMMU_CB_TTBR1 = smmu_page_base_addr;/*lint !e712 */

	all_reg->SMMU_FAMA_CTRL1_NS.bits.fama_ptw_msb_ns = (smmu_page_base_addr >> 32) & 0x7F;
...
HI_VOID vedu_hal_cfg_reg_simple(struct encode_info *channel_cfg, HI_U32 *reg_base, HI_BOOL *first_cfg_flag)
{
	...
	if (*first_cfg_flag == HI_TRUE) {
		vedu_hal_cfg_reg_smmu_set(reg_base);
...
HI_VOID vedu_hal_cfg_reg(struct encode_info *channel_cfg, HI_U32 *reg_base, HI_BOOL *first_cfg_flag)
{
...

	{
		...
		all_reg->VEDU_VCPI_CLKDIV_ENABLE.u32 = D32.u32;//channel_cfg->all_reg.VEDU_VCPI_CLKDIV_ENABLE.u32;
	}
...

	{
		...
		D32.bits.vcpi_intra32_low_power_en = channel_cfg->all_reg.VEDU_VCPI_INTRA32_LOW_POWER.bits.vcpi_intra32_low_power_en;//DIST_PROTOCOL(vcpi_protocol, 1, 0);
...

	{
		...
		D32.bits.vcpi_intra16_low_power_en = channel_cfg->all_reg.VEDU_VCPI_INTRA16_LOW_POWER.bits.vcpi_intra16_low_power_en;//DIST_PROTOCOL(vcpi_protocol, 1, 0);
...

	{
		...
		D32.bits.pme_intra_lowpow_en = channel_cfg->all_reg.VEDU_PME_INTRA_LOWPOW.bits.pme_intra_lowpow_en;//DIST_PROTOCOL(vcpi_protocol, 0x1, 0);
...

	{
		...
		D32.bits.qpg_skin_max_qp = channel_cfg->all_reg.VEDU_QPG_SKIN.bits.qpg_skin_max_qp;//DIST_PROTOCOL(vcpi_protocol, 0x1E, 0x33);
		D32.bits.qpg_skin_qp_delta = channel_cfg->all_reg.VEDU_QPG_SKIN.bits.qpg_skin_qp_delta;//DIST_PROTOCOL(vcpi_protocol, 0x2, 0x3);
	...
	{
		all_reg->VEDU_QPG_CU_MIN_SAD_THRESH_0 = 0x0C080401;//channel_cfg->all_reg.VEDU_QPG_CU_MIN_SAD_THRESH_0;
	}

	{
		all_reg->VEDU_QPG_CU_MIN_SAD_THRESH_1 = 0xB4825A3C;//channel_cfg->all_reg.VEDU_QPG_CU_MIN_SAD_THRESH_1;
	}
...

	{
		...
		D32.bits.fme_pu64_lwp_flag = channel_cfg->all_reg.VEDU_FME_PU64_LWP.bits.fme_pu64_lwp_flag;//0x1;
	...
	{
		all_reg->VEDU_MRG_BIAS_COST0.u32 = 0; //02;
	}
